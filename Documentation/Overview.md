...
### Methods for Consuming the Acrade Shared Infrastructure Components
...
- If a tool provides functionality which is meant to be used by all of the Repos then we should add it to the SDK. 
