    ...
    public class Command : ICommand
    {
        ...
        public CommandResult Execute()
        {
            ...
            if (_process.StartInfo.RedirectStandardOutput)
            {
                ...
                {
                    Command.ProcessData(args.Data, _stdOutCapture, _stdOutForward, _stdOutHandler);
                };
            }
            ...
            if (_process.StartInfo.RedirectStandardError)
            {
                ...
                {
                    Command.ProcessData(args.Data, _stdErrCapture, _stdErrForward, _stdErrHandler);
                };
            }
        ...
        private void ReportExecEnd(int exitCode)
        {
            if (!_quietBuildReporter && _statusForward != null)
            {
                ...
                var message = $"{Command.FormatProcessInfo(_process.StartInfo, includeWorkingDirectory: !success)} exited with {exitCode}";
